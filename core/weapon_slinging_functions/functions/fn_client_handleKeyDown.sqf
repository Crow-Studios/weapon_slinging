    ...
    if (profileNamespace getVariable ["crow_sling_autoSling", false]) then 
    {
        ...
        switch (true) do
        {
            case ((_this select 1) in actionKeys "SwitchHandgun"):
            {
                ...
                [_unit, _weapon, "handgun"] call weapon_slinging_fnc_client_slingWeapon;
            };
            ...
            case ((_this select 1) in actionKeys "SwitchSecondary"):
            {
                ...
                [_unit, _weapon, "secondary"] call weapon_slinging_fnc_client_slingWeapon; 
            };
            ...
            case ((_this select 1) in actionKeys "binocular"):
            {
                ...
                [_unit, _weapon, "binocular"] call weapon_slinging_fnc_client_slingWeapon;
            };
